...
- P0: LOGO DECISION (use-as-is vs controlled refinement); Phase 6 TMMS + 4 demos (client supplies demo files); Phase 8 Contact + enquiry pipeline (Resend DNS records needed from client for sending domain; form stays disabled until delivery test); Phase 9 articles (blocked on client's stat source-or-remove decisions)
